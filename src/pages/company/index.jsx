...
const companyData = [
  ...
  {
    id:1,
    companyTitle:"Terms & Conditions",
    companyDetails:"",
    status:"Inactive"
  },
  {
    id:1,
    companyTitle:"Privacy Policy",
    companyDetails:"",
    status:"Inactive"
  }
]
  ...
  useEffect(() => {
    if (query) {
      const searchData = data?.filter(
        (item) =>
          item.companyTitle.toLowerCase().includes(query.toLowerCase()) ||
          item.companyDescription.toLowerCase().includes(query.toLowerCase()) 
      );
      setData(searchData);
    }
    if (query === "") {
  ...
  const orderColumns = [
    {
      ...
      key: "companyTitle",
      sorter: (a, b) => {
        return a.companyTitle > b.companyTitle;
      },
      ellipsis: {
        showTitle: false,
      },
      onCell: (record, rowIndex) => {
        return {
          onClick: () => {
            showViewPage();
            localStorage.setItem("companyData", JSON.stringify(record));
          },
        };
      },
      responsive: ["xs", "md"],
...

    {
      ...
      key: "companyDetails",
      sorter: (a, b) => a.companyDetails > b.companyDetails,
      ellipsis: {
        showTitle: false,
      },
      responsive: ["xs", "md"],
