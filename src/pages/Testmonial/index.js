...
import AddTestmonial from "./Addtestmonial";
// import ViewOrders from "./view-orders/view-orders";
import Edittestmonial from "./Edit-testmonial";
import Index from "./Addtestmonial";
 
const orderData = [
  {
    id: 1,
    Image: "",
    name: "Automate Your business workflow to using Accufy",
    feedback: "Save time and get paid faster with recurring invoices, and send automatic payment…	",
    action: "",
  },
  {
    id: 2,
    ...
    <>
      ...
      {edit && (
        <SideDrawer
          ...
          bodyStyle={{ backgroundColor: "white", padding: "30px" }}
        >
          <Edittestmonial setEdit={setEdit} />
        </SideDrawer>
      )}
        ...
        <div className="flex flex-row justify-between ">
          <div>
            ...
            <p className="text-base text-gray-400">
              Manage the details of your all kind of testimonial
            </p>
          </div>
          <div
