...
const orderData = [
  {
    id: 1,
    tittle: "Automate Your business workflow to using Accufy",
    detail: "Save time and get paid faster with recurring invoices, and send automatic payment…	",
    action: "",
  },
  {
    id: 2,
        ...
        <div className="flex flex-row justify-between ">
          <div>
            ...
            <p className="text-base text-gray-400">
              Manage the details of your all kind of Faqs
            </p>
          </div>
          <div
